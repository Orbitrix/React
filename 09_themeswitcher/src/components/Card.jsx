...
export default function Card() {
    ...
    return (
        <div className="w-full bg-white border border-gray-200 rounded-lg shadow transition-colors duration-300 
            dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl">
            <a href="/">
